...
SECRET_KEY = 'django-insecure-h-%22)w2%xteigaicd$fdek!q+ejy*7-@qs=ty64++7&h$6gly'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        'meetme_app.permissions.StrictModelPermissions',
    ],
...
ACCOUNT_FORMS = {
    'signup': 'accounts.forms.SimpleSignupForm',
    'login': 'accounts.forms.BSLoginForm',
}
